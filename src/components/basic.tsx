...
const FormTextArea: React.FC<FormTextAreaProps> = ({
  ...
  return (
    <div className={className}>
      ...
      <Controller
        ...
        render={({ field }) => (
          <textarea
            {...field}
            placeholder={placeholder}
            style={{ width: "65.5vw", marginTop: "20px", height: "120px" }}
      ...
      />
      {errors[name] && (
        <span className={classError} style={{ color: "red", fontSize: 12 }}>
          {String(errors[name]?.message)}
        </span>
      )}
    </div>
...
export { FormInput, FormCheckBox,FormSelect, FormTextArea };
